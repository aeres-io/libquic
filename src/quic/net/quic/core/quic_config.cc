...
const IPEndPoint& QuicFixedSocketAddress::GetSendValue() const {
  return send_value_;
}

void QuicFixedSocketAddress::SetSendValue(const IPEndPoint& value) {
  has_send_value_ = true;
  send_value_ = value;
}
...
const IPEndPoint& QuicFixedSocketAddress::GetReceivedValue() const {
  return receive_value_;
}

void QuicFixedSocketAddress::SetReceivedValue(const IPEndPoint& value) {
  has_receive_value_ = true;
  receive_value_ = value;
}
