...
class QUIC_EXPORT_PRIVATE QuicConnectionHelper {
 public:
   QuicConnectionHelper(const QuicClock* clock,
  ...
  QuicBufferAllocator* GetStreamSendBufferAllocator();
...
class QUIC_EXPORT_PRIVATE QuicConnection
  ...
  friend class QuicConnectionVisitor;
 ...
 public:
  ...
  // Accessors
  QuicConnectionVisitorInterface * get_visitor() { return visitor_; }
 ...
 private:
  ...
  QuicConnectionHelper* helper_;  // Not owned.
