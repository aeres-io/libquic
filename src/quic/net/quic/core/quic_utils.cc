...
uint128 IncrementalHashFast(uint128 uhash, base::StringPiece data) {
...
uint128 IncrementalHashSlow(uint128 hash, base::StringPiece data) {
  // kPrime = 309485009821345068724781371
...
uint128 IncrementalHash(uint128 hash, base::StringPiece data) {
#ifdef QUIC_UTIL_HAS_UINT128
...
// static
uint64_t QuicUtils::FNV1a_64_Hash(base::StringPiece data) {
...
// static
uint128 QuicUtils::FNV1a_128_Hash(base::StringPiece data) {
  return FNV1a_128_Hash_Three(data, base::StringPiece(), base::StringPiece());
}

// static
uint128 QuicUtils::FNV1a_128_Hash_Two(base::StringPiece data1,
                                      base::StringPiece data2) {
  return FNV1a_128_Hash_Three(data1, data2, base::StringPiece());
}

// static
uint128 QuicUtils::FNV1a_128_Hash_Three(base::StringPiece data1,
                                        base::StringPiece data2,
...
PeerAddressChangeType QuicUtils::DetermineAddressChangeType(
  ...
  if (old_address.GetFamily() == net::ADDRESS_FAMILY_UNSPECIFIED || new_address.GetFamily() == net::ADDRESS_FAMILY_UNSPECIFIED ||
  ...
  bool old_ip_is_ipv4 = old_address.address().IsIPv4() ? true : false;
  bool migrating_ip_is_ipv4 = new_address.address().IsIPv4() ? true : false;
  ...
  if (IPAddressMatchesPrefix(old_address.address(), new_address.address(), kSubnetMaskLength)) {
