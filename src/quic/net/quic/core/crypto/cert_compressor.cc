...
// static
bool CertCompressor::DecompressChain(base::StringPiece in,
                                     const std::vector<string>& cached_certs,
                                     const CommonCertSets* common_sets,
                                     std::vector<string>* out_certs) {
  std::vector<CertEntry> entries;
