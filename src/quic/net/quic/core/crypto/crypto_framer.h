...
class QUIC_EXPORT_PRIVATE CryptoFramer : public CryptoMessageParser {
 public:
  ...
  // ParseMessage parses exactly one message from the given base::StringPiece. If
  ...
  bool ProcessInput(base::StringPiece input, Perspective perspective) override;
 ...
 private:
  ...
  QuicErrorCode Process(base::StringPiece input, Perspective perspective);
