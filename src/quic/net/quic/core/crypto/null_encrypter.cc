...
bool NullEncrypter::SetKey(base::StringPiece key) {
  return key.empty();
}

bool NullEncrypter::SetNoncePrefix(base::StringPiece nonce_prefix) {
  return nonce_prefix.empty();
}

bool NullEncrypter::SetIV(base::StringPiece iv) {
  return iv.empty();
}
...
base::StringPiece NullEncrypter::GetKey() const {
  return base::StringPiece();
}

base::StringPiece NullEncrypter::GetNoncePrefix() const {
  return base::StringPiece();
}
