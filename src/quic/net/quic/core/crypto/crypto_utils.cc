...
// static
bool CryptoUtils::DeriveKeys(base::StringPiece premaster_secret,
                             QuicTag aead,
  ...
  base::StringPiece nonce = client_nonce;
...
// static
bool CryptoUtils::ExportKeyingMaterial(base::StringPiece subkey_secret,
  ...
  crypto::HKDF hkdf(subkey_secret, base::StringPiece() /* no salt */, info,
...
// static
uint64_t CryptoUtils::ComputeLeafCertHash(base::StringPiece cert) {
