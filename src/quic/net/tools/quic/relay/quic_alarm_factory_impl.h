...
class NET_EXPORT_PRIVATE QuicAlarmFactoryImpl : public QuicAlarmFactory {
 public:
   QuicAlarmFactoryImpl(base::TaskRunner* task_runner,
 ...
 private:
  ...
  base::WeakPtrFactory<QuicAlarmFactoryImpl> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(QuicAlarmFactoryImpl);
};
