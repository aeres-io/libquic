...
#ifndef NET_QUIC_CORE_QUIC_RAW_SERVER_HANDSHAKER_H_
#define NET_QUIC_CORE_QUIC_RAW_SERVER_HANDSHAKER_H_
...
class QUIC_EXPORT_PRIVATE QuicRawServerHandshaker
 ...
 public:
  ...
  QuicRawServerHandshaker(const QuicCryptoServerConfig* crypto_config,
  ...
  ~QuicRawServerHandshaker() override;
 ...
 protected:
  ...
  virtual const IPEndPoint GetClientAddress();

 private:

  class ValidateCallback : public ValidateClientHelloResultCallback {
   public:
    explicit ValidateCallback(QuicRawServerHandshaker* parent);
  ...
  class SendServerConfigUpdateCallback
   ...
   public:
    explicit SendServerConfigUpdateCallback(QuicRawServerHandshaker* parent);
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicRawServerHandshaker);
};

}  // namespace net

#endif  // NET_QUIC_CORE_QUIC_RAW_SERVER_HANDSHAKER_H_
