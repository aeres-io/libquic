...
class QuicAlarmImpl : public QuicAlarm {
 public:
   QuicAlarmImpl(const QuicClock* clock,
 ...
 protected:
  void SetImpl() override {
    ...
    task_runner_->PostDelayedTask(
        base::Bind(&QuicAlarmImpl::OnAlarm, weak_factory_.GetWeakPtr()),
 ...
 private:
  ...
  base::WeakPtrFactory<QuicAlarmImpl> weak_factory_;
};

}  // namespace

QuicAlarmFactoryImpl::QuicAlarmFactoryImpl(
    base::TaskRunner* task_runner,
...
QuicArenaScopedPtr<QuicAlarm> QuicAlarmFactoryImpl::CreateAlarm(
    QuicArenaScopedPtr<QuicAlarm::Delegate> delegate,
...
QuicAlarm* QuicAlarmFactoryImpl::CreateAlarm(
    QuicAlarm::Delegate* delegate) {
  return new QuicAlarmImpl(clock_, task_runner_,
                             QuicArenaScopedPtr<QuicAlarm::Delegate>(delegate));
}
