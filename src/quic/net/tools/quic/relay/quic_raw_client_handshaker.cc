...
QuicRawClientHandshaker::ChannelIDSourceCallbackImpl::
    ChannelIDSourceCallbackImpl(QuicRawClientHandshaker* parent)
    : parent_(parent) {}

QuicRawClientHandshaker::ChannelIDSourceCallbackImpl::
    ~ChannelIDSourceCallbackImpl() {}

void QuicRawClientHandshaker::ChannelIDSourceCallbackImpl::Run(
...
void QuicRawClientHandshaker::ChannelIDSourceCallbackImpl::Cancel() {
  parent_ = nullptr;
}

QuicRawClientHandshaker::ProofVerifierCallbackImpl::
    ProofVerifierCallbackImpl(QuicRawClientHandshaker* parent)
    : parent_(parent) {}

QuicRawClientHandshaker::ProofVerifierCallbackImpl::
    ~ProofVerifierCallbackImpl() {}

void QuicRawClientHandshaker::ProofVerifierCallbackImpl::Run(
    bool ok,
...
void QuicRawClientHandshaker::ProofVerifierCallbackImpl::Cancel() {
  parent_ = nullptr;
}

QuicRawClientHandshaker::QuicRawClientHandshaker(
...
void QuicRawClientHandshaker::OnHandshakeMessage(
...
bool QuicRawClientHandshaker::CryptoConnect() {
  next_state_ = STATE_INITIALIZE;
  DoHandshakeLoop(nullptr);
  return session()->connection()->connected();
}

int QuicRawClientHandshaker::num_sent_client_hellos() const {
  return num_client_hellos_;
}

int QuicRawClientHandshaker::num_scup_messages_received() const {
  return num_scup_messages_received_;
}

bool QuicRawClientHandshaker::WasChannelIDSent() const {
  return channel_id_sent_;
}

bool QuicRawClientHandshaker::WasChannelIDSourceCallbackRun() const {
  return channel_id_source_callback_run_;
}

string QuicRawClientHandshaker::chlo_hash() const {
  return chlo_hash_;
}

bool QuicRawClientHandshaker::encryption_established() const {
  return encryption_established_;
}

bool QuicRawClientHandshaker::handshake_confirmed() const {
  return handshake_confirmed_;
}

const QuicCryptoNegotiatedParameters&
QuicRawClientHandshaker::crypto_negotiated_params() const {
  return *crypto_negotiated_params_;
}

CryptoMessageParser* QuicRawClientHandshaker::crypto_message_parser() {
  return QuicCryptoHandshaker::crypto_message_parser();
}

void QuicRawClientHandshaker::HandleServerConfigUpdateMessage(
...
void QuicRawClientHandshaker::DoHandshakeLoop(
...
void QuicRawClientHandshaker::DoInitialize(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicRawClientHandshaker::DoSendCHLO(
    QuicCryptoClientConfig::CachedState* cached) {
  ...
  if (!cached->IsComplete(session()->connection()->clock()->WallNow())) {
    crypto_config_->FillInchoateClientHello(
        server_id_, session()->connection()->transport_version(),
  ...
  QuicErrorCode error = crypto_config_->FillClientHello(
      ...
      session()->connection()->transport_version(), cached,
...
void QuicRawClientHandshaker::DoReceiveREJ(
    const CryptoHandshakeMessage* in,
    QuicCryptoClientConfig::CachedState* cached) {
...
QuicAsyncStatus QuicRawClientHandshaker::DoVerifyProof(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicRawClientHandshaker::DoVerifyProofComplete(
    QuicCryptoClientConfig::CachedState* cached) {
  if (!verify_ok_) {
    if (verify_details_) {
...
QuicAsyncStatus QuicRawClientHandshaker::DoGetChannelID(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicRawClientHandshaker::DoGetChannelIDComplete() {
...
void QuicRawClientHandshaker::DoReceiveSHLO(
    const CryptoHandshakeMessage* in,
    QuicCryptoClientConfig::CachedState* cached) {
  next_state_ = STATE_NONE;
...
void QuicRawClientHandshaker::DoInitializeServerConfigUpdate(
    QuicCryptoClientConfig::CachedState* cached) {
...
void QuicRawClientHandshaker::SetCachedProofValid(
    QuicCryptoClientConfig::CachedState* cached) {
  cached->SetProofValid();
  proof_handler_->OnProofValid(*cached);
}

bool QuicRawClientHandshaker::RequiresChannelID(
    QuicCryptoClientConfig::CachedState* cached) {
