...
class QUIC_EXPORT_PRIVATE QuicRawClientHandshaker
    : public QuicCryptoClientStream::HandshakerDelegate,
      public QuicCryptoHandshaker {
 public:
  QuicRawClientHandshaker(
  ...
  ~QuicRawClientHandshaker() override;
 ...
 private:
  ...
  class ChannelIDSourceCallbackImpl : public ChannelIDSourceCallback {
   public:
    explicit ChannelIDSourceCallbackImpl(QuicRawClientHandshaker* parent);
   ...
   private:
    QuicRawClientHandshaker* parent_;
  };
  ...
  class ProofVerifierCallbackImpl : public ProofVerifierCallback {
   public:
    explicit ProofVerifierCallbackImpl(QuicRawClientHandshaker* parent);
  ...
  DISALLOW_COPY_AND_ASSIGN(QuicRawClientHandshaker);
};
